...
QVariant SvdModel::headerData(int section, Qt::Orientation orientation, int role) const
{
...
QModelIndex SvdModel::index(int row, int column, const QModelIndex &parent) const
{
